  ...
  experience: [
    {
      ...
      description: "➥ Contributing to OpenChoreo, a CNCF open-source Internal Developer Platform (IDP).\n➥ Designing and implementing a deployment revision history and rollback system for OpenChoreo.\n➥ Developing Kubernetes Custom Resource Definitions (CRDs) and controller logic using controller-runtime.\n➥ Building safe, idempotent rollback mechanisms and REST APIs for deployment revision management.\n➥ Developing occ CLI commands and contributing to the Backstage UI for deployment history and rollback.\n➥ Writing unit, integration (envtest), and end-to-end tests while contributing to cloud-native open-source development using Go, Kubernetes, React, TypeScript, and OpenAPI.",
      technologies: [
        "Go",
        "Kubernetes",
        "CRDs",
